	...
	<h2>Patients for Today [<?php echo date("M. d, Y"); ?>]</h2> 
	<script>	
	...
	<table id="rounded-corner" class="fluid">
		...
		<tbody>
			...
			<?= ($cntr%2 == 0) ? "<tr style='background-color:#f5f5f5;'>" : "<tr style='background-color:#ffffff;'>"; ?>
				...
				<td id="tr_<?php echo $patient->patient_id; ?>" title=""><?php echo $patient->first_name." ".$patient->last_name; ?></td>
	...
	<a href="<?php echo base_url('dashboard/add_patient'); ?>" class="bt_green"><span class="bt_green_lft"></span><strong>Add New Patient</strong><span class="bt_green_r"></span></a>
